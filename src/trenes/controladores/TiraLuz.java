...
public final class TiraLuz extends ControlServicio implements Activable, Modificable {
     ...
     * valores rojo, verde y azul. Y por último, se asigna al tipo de Control de
     * Servicio de la superclase o la clase padre el valor de "TiraLuz",
    ...
    public TiraLuz​(boolean encendida, String ubicacionTira, int intensidadTira,
            int colorRojo, int colorVerde, int colorAzul, String nombreControlServicio) {
     ...
     * el nombre del controlDeServicio de la clase padre o superclase con el
     * atributo pasado en cuarto lugar. Por otra parte se inicializa el estado
     * de la tira para establecer si está encendida o no pasado como primer
     * parámetro. Como segundo parámetro se pasa la ubicación de la tira de
     * luces. Además se inicializa la intensidad de luz de la tira según el
     * valor pasado como tercer parámetro. Los valores para el color Rojo, Verde
     * y Azul se generarán automáticamente con valores entre 0 y 255. Y por
     * último, se asigna al tipo de Control de Servicio de la superclase o la
     * clase padre el valor de "TiraLuz", identificando de esta forma el tipo de
    ...
    /**
     * Método estático generarColorAleatorio que genera un valor entero
     * aleatorio entre 1 y 255, que nos ayudará a asignar valores a los colores
     * de las tiras de luz
     *
