 ...
 * vagón del tren. No es instanciable.
 *
...
public abstract class ControlServicio {
    ...
    /**
     * Constructor con un parámetro de ControlServicio. Este constructor
     * simplemente recibe un nombre de control de servicio para asignarlo al
     * control que se va a crear. Automáticamente asignar el identificador de
     * Control de Servicio (idControlServicio) a partir del número de controles
     * existentes ya configurados. Y asigna como tipo de Control de servicio
     * (tipoControlServicio) el valor "Desconocido"
     *
     * @param nombreControlServicio Cadena con el nombre a asignar a este
     * control
     */
    ...
    /**
     * Constructor sin parámetros de ControlServicio. Este constructor
     * simplemente inicializa valores por defecto al control que se va a crear.
     * Automáticamente asignar el identificador de Control de Servicio
     * (idControlServicio) a partir del número de controles existentes ya
     * configurados. Y asigna como tipo de Control de servicio
     * (tipoControlServicio) el valor "Desconocido". De la misma forma asigna
     * "Desconocido" al nombre de control de Servicio (nombreControlServicio)
     */
    ...
    /**
     * Método estático observador (getter) número de controles actualmente
     * configurados
     *
    ...
    /**
     * Método observador (getter) que devuelve el tipo de control de servicio
     * del objeto
     *
    ...
    /**
     * Método modificador (setter) que asigna el tipo de control de servicio al
     * que pertenece este objeto. Para que se pueda asignar dicho valor se debe
     * comprobar que pertenezca a uno de los cuatro tipos permitidos: "Puerta",
     * Ventanilla, "Altavoz" o "TiraLuz". En caso de no corresponderse el
     * parámetro para asignar con ninguno de estos cuatro tipos se asignará
     * "Desconocido"
     *
     * @param tipoControlServicio tipo de control de servicio que se debe
     * asignar
     */
     ...
     * atributos Cada atributo aparecerá en una línea y su tabulación
     *
