...
public final class VentanillaVagon extends ControlServicio implements Modificable {
    ...
    /**
     * Constructor con tres parámetros de VentanillaVagon. Este constructor inicializa el nombre 
     * del controlDeServicio de la clase padre o superclase con el atributo pasado en tercer lugar. 
     * Por otra parte se inicializa la opacidad de la ventanilla con el parámetro pasado como primer 
     * parámetro Además se inicializa la ubicación según el valor String pasado como segundo parámetro. 
     * Asignamos al tipo de Control de Servicio de la superclase o la clase padre el valor de "Ventanilla", 
    ...
    /**
     * Constructor con dos parámetros de VentanillaVagon. Este constructor inicializa el nombre del controlDeServicio 
     * de la clase padre o superclase con el atributo pasado en segundo lugar. Además se inicializa la ubicación según 
     * el valor String pasado como primer parámetro. Asignamos al tipo de Control de Servicio de la superclase o la clase 
     * padre el valor de "Ventanilla", identificando de esta forma el tipo de Control de servicio que es.
     * Establecemos la opacidad en 0 (aporvechando así el constructor de 3 paraámetros.
     * 
     * @param ubicacionVentanilla Ubicación de la ventanilla
     * @param nombreControlServicio nombre que se le va a asignar a este tipo de control de Servicio.
     */
    ...
    /**
     * Método observador (getter) que devuelve el porcentaje de opacidad de la ventana
     *
    ...
    /**
     * Método modificador (setter) que establece el nuevo el porcentaje de opacidad de la 
     * ventana. Este valor se asignará si su valor está comprendido entre MIN y MAX de la 
     * interfaz Activable ambos inclusive.
     * 
    ...
    /**
     * Método modificador (setter) que establece la nueva ubicación a la ventana.
     * 
     * @param ubicacionVentanilla Cadena que representa la ubicación de la ventana.
     */
     ...
     * opacidad de la ventanilla en 5 unidades. No puede superar el valor máximo 100
     * 
     * @throws IllegalStateException  si ventanilla ya está en su valor máximo de opacidad
     */
    @Override
